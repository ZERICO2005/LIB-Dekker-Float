 ...
 */
static inline int mpfr_set_float128x2(mpfr_t rop, const Float128x2 op, const mpfr_rnd_t rnd) {
	mpfr_t temp;
 ...
 */
static inline Float128x2 mpfr_get_float128x2(mpfr_srcptr op, const mpfr_rnd_t rnd) {
	mpfr_t src;
