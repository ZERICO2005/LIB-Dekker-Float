 ...
 */
static inline int mpfr_set_float32x2(mpfr_t rop, const Float32x2 op, const mpfr_rnd_t rnd) {
 ...
 */
static inline Float32x2 mpfr_get_float32x2(mpfr_srcptr op, const mpfr_rnd_t rnd) {
	mpfr_t src;
