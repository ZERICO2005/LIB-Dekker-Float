 ...
 */
inline int mpfr_set_float64x4(mpfr_t rop, const Float64x4 op, const mpfr_rnd_t rnd) {
 ...
 */
inline Float64x4 mpfr_get_float64x4(mpfr_srcptr op, const mpfr_rnd_t rnd) {
	mpfr_t src;
