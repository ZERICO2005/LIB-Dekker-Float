...
static inline __m256dx2 _mm256x2_not_pdx2(__m256dx2 x) {
	x.hi = _mm256_not_pd(x.hi);
	x.lo = _mm256_not_pd(x.lo);
	return x;
}
...
//------------------------------------------------------------------------------
// __m256dx2 comparison functions
//------------------------------------------------------------------------------
...
/* __m256dx2 compare __m256dx2 */
	 ...
	 * @brief _CMP_EQ_UQ
	 */
	static inline __m256d _mm256_cmplg_pdx2(__m256dx2 x, __m256dx2 y) {
	 ...
	 * @brief _CMP_NEQ_UQ
	 */
	static inline __m256d _mm256_cmpnlg_pdx2(__m256dx2 x, __m256dx2 y) {
	...
	static inline __m256d _mm256_cmplt_pdx2(__m256dx2 x, __m256dx2 y) {
		return _mm256_or_pd(
			_mm256_cmp_pd(x.hi, y.hi, _CMP_LT_OQ),
			_mm256_and_pd(
				_mm256_cmp_pd(x.hi, y.hi, _CMP_EQ_OQ),
				_mm256_cmp_pd(x.lo, y.lo, _CMP_LT_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmple_pdx2(__m256dx2 x, __m256dx2 y) {
		return _mm256_or_pd(
			...
			_mm256_and_pd(
				_mm256_cmp_pd(x.hi, y.hi, _CMP_EQ_OQ),
				_mm256_cmp_pd(x.lo, y.lo, _CMP_LE_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpgt_pdx2(__m256dx2 x, __m256dx2 y) {
		return _mm256_or_pd(
			_mm256_cmp_pd(x.hi, y.hi, _CMP_GT_OQ),
			_mm256_and_pd(
				_mm256_cmp_pd(x.hi, y.hi, _CMP_EQ_OQ),
				_mm256_cmp_pd(x.lo, y.lo, _CMP_GT_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpge_pdx2(__m256dx2 x, __m256dx2 y) {
		return _mm256_or_pd(
			...
			_mm256_and_pd(
				_mm256_cmp_pd(x.hi, y.hi, _CMP_EQ_OQ),
				_mm256_cmp_pd(x.lo, y.lo, _CMP_GE_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpnlt_pdx2(__m256dx2 x, __m256dx2 y) {
		return _mm256_and_pd(
			_mm256_cmp_pd(x.hi, y.hi, _CMP_NLT_UQ),
			_mm256_or_pd(
				_mm256_cmp_pd(x.hi, y.hi, _CMP_NEQ_OQ),
				_mm256_cmp_pd(x.lo, y.lo, _CMP_NLT_UQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpnle_pdx2(__m256dx2 x, __m256dx2 y) {
		return _mm256_and_pd(
			...
			_mm256_or_pd(
				_mm256_cmp_pd(x.hi, y.hi, _CMP_NEQ_OQ),
				_mm256_cmp_pd(x.lo, y.lo, _CMP_NLE_UQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpngt_pdx2(__m256dx2 x, __m256dx2 y) {
		return _mm256_and_pd(
			_mm256_cmp_pd(x.hi, y.hi, _CMP_NGT_UQ),
			_mm256_or_pd(
				_mm256_cmp_pd(x.hi, y.hi, _CMP_NEQ_OQ),
				_mm256_cmp_pd(x.lo, y.lo, _CMP_NGT_UQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpnge_pdx2(__m256dx2 x, __m256dx2 y) {
		return _mm256_and_pd(
			...
			_mm256_or_pd(
				_mm256_cmp_pd(x.hi, y.hi, _CMP_NEQ_OQ),
				_mm256_cmp_pd(x.lo, y.lo, _CMP_NGE_UQ)
			)
		);
	}
...
/* __m256dx2 compare __m256d */
	 ...
	 * @brief _CMP_NEQ_UQ
	 */
	static inline __m256d _mm256_cmplg_pdx2_pd(__m256dx2 x, __m256d y) {
	 ...
	 * @brief _CMP_EQ_UQ
	 */
	static inline __m256d _mm256_cmpnlg_pdx2_pd(__m256dx2 x, __m256d y) {
	...
	static inline __m256d _mm256_cmplt_pdx2_pd(__m256dx2 x, __m256d y) {
		return _mm256_or_pd(
			_mm256_cmp_pd(x.hi, y, _CMP_LT_OQ),
			_mm256_and_pd(
				_mm256_cmp_pd(x.hi, y, _CMP_EQ_OQ),
				_mm256_cmp_pd(x.lo, _mm256_setzero_pd(), _CMP_LT_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmple_pdx2_pd(__m256dx2 x, __m256d y) {
		return _mm256_or_pd(
			...
			_mm256_and_pd(
				_mm256_cmp_pd(x.hi, y, _CMP_EQ_OQ),
				_mm256_cmp_pd(x.lo, _mm256_setzero_pd(), _CMP_LE_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpgt_pdx2_pd(__m256dx2 x, __m256d y) {
		return _mm256_or_pd(
			_mm256_cmp_pd(x.hi, y, _CMP_GT_OQ),
			_mm256_and_pd(
				_mm256_cmp_pd(x.hi, y, _CMP_EQ_OQ),
				_mm256_cmp_pd(x.lo, _mm256_setzero_pd(), _CMP_GT_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpge_pdx2_pd(__m256dx2 x, __m256d y) {
		return _mm256_or_pd(
			...
			_mm256_and_pd(
				_mm256_cmp_pd(x.hi, y, _CMP_EQ_OQ),
				_mm256_cmp_pd(x.lo, _mm256_setzero_pd(), _CMP_GE_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpnlt_pdx2_pd(__m256dx2 x, __m256d y) {
		return _mm256_or_pd(
			_mm256_cmp_pd(x.hi, y, _CMP_NLT_UQ),
			_mm256_and_pd(
				_mm256_cmp_pd(x.hi, y, _CMP_NEQ_OQ),
				_mm256_cmp_pd(x.lo, _mm256_setzero_pd(), _CMP_NLT_UQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpnle_pdx2_pd(__m256dx2 x, __m256d y) {
		return _mm256_and_pd(
			...
			_mm256_or_pd(
				_mm256_cmp_pd(x.hi, y, _CMP_NEQ_OQ),
				_mm256_cmp_pd(x.lo, _mm256_setzero_pd(), _CMP_NLE_UQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpngt_pdx2_pd(__m256dx2 x, __m256d y) {
		return _mm256_and_pd(
			_mm256_cmp_pd(x.hi, y, _CMP_NGT_UQ),
			_mm256_or_pd(
				_mm256_cmp_pd(x.hi, y, _CMP_NEQ_OQ),
				_mm256_cmp_pd(x.lo, _mm256_setzero_pd(), _CMP_NGT_UQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpnge_pdx2_pd(__m256dx2 x, __m256d y) {
		return _mm256_and_pd(
			...
			_mm256_or_pd(
				_mm256_cmp_pd(x.hi, y, _CMP_NEQ_OQ),
				_mm256_cmp_pd(x.lo, _mm256_setzero_pd(), _CMP_NGE_UQ)
			)
		);
	}
...
/* __m256d compare __m256dx2 */
	 ...
	 * @brief _CMP_NEQ_UQ
	 */
	static inline __m256d _mm256_cmplg_pd_pdx2(__m256d x, __m256dx2 y) {
	 ...
	 * @brief _CMP_EQ_UQ
	 */
	static inline __m256d _mm256_cmpeqnlg_pd_pdx2(__m256d x, __m256dx2 y) {
	...
	static inline __m256d _mm256_cmplt_pd_pdx2(__m256d x, __m256dx2 y) {
		return _mm256_or_pd(
			_mm256_cmp_pd(x, y.hi, _CMP_LT_OQ),
			_mm256_and_pd(
				_mm256_cmp_pd(x, y.hi, _CMP_EQ_OQ),
				_mm256_cmp_pd(_mm256_setzero_pd(), y.lo, _CMP_LT_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmple_pd_pdx2(__m256d x, __m256dx2 y) {
		return _mm256_or_pd(
			...
			_mm256_and_pd(
				_mm256_cmp_pd(x, y.hi, _CMP_EQ_OQ),
				_mm256_cmp_pd(_mm256_setzero_pd(), y.lo, _CMP_LE_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpgt_pd_pdx2(__m256d x, __m256dx2 y) {
		return _mm256_or_pd(
			_mm256_cmp_pd(x, y.hi, _CMP_GT_OQ),
			_mm256_and_pd(
				_mm256_cmp_pd(x, y.hi, _CMP_EQ_OQ),
				_mm256_cmp_pd(_mm256_setzero_pd(), y.lo, _CMP_GT_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpge_pd_pdx2(__m256d x, __m256dx2 y) {
		return _mm256_or_pd(
			...
			_mm256_and_pd(
				_mm256_cmp_pd(x, y.hi, _CMP_EQ_OQ),
				_mm256_cmp_pd(_mm256_setzero_pd(), y.lo, _CMP_GE_OQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpnlt_pd_pdx2(__m256d x, __m256dx2 y) {
		return _mm256_or_pd(
			_mm256_cmp_pd(x, y.hi, _CMP_NLT_UQ),
			_mm256_and_pd(
				_mm256_cmp_pd(x, y.hi, _CMP_NEQ_OQ),
				_mm256_cmp_pd(_mm256_setzero_pd(), y.lo, _CMP_NLT_UQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpnle_pd_pdx2(__m256d x, __m256dx2 y) {
		return _mm256_and_pd(
			...
			_mm256_or_pd(
				_mm256_cmp_pd(x, y.hi, _CMP_NEQ_OQ),
				_mm256_cmp_pd(_mm256_setzero_pd(), y.lo, _CMP_NLE_UQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpngt_pd_pdx2(__m256d x, __m256dx2 y) {
		return _mm256_and_pd(
			_mm256_cmp_pd(x, y.hi, _CMP_NGT_UQ),
			_mm256_or_pd(
				_mm256_cmp_pd(x, y.hi, _CMP_NEQ_OQ),
				_mm256_cmp_pd(_mm256_setzero_pd(), y.lo, _CMP_NGT_UQ)
			)
		);
	}
	...
	static inline __m256d _mm256_cmpnge_pd_pdx2(__m256d x, __m256dx2 y) {
		return _mm256_and_pd(
			...
			_mm256_or_pd(
				_mm256_cmp_pd(x, y.hi, _CMP_NEQ_OQ),
				_mm256_cmp_pd(_mm256_setzero_pd(), y.lo, _CMP_NGE_UQ)
			)
		);
	}
 ...
 * @note Assumes that if x.hi is zero then x.lo is also zero.
 */
static inline __m256d _mm256_cmplg_zero_pdx2(__m256dx2 x) {
 ...
 * @note Assumes that if x.hi is zero then x.lo is also zero.
 */
static inline __m256d _mm256_cmpnlg_zero_pdx2(__m256dx2 x) {
 ...
 * @note Assumes that if x.hi is zero then x.lo is also zero.
 */
static inline __m256d _mm256_cmpnlt_zero_pdx2(__m256dx2 x) {
	return _mm256_cmp_pd(x.hi, _mm256_setzero_pd(), _CMP_NLT_UQ);
}
/**
 * @brief _CMP_NLE_UQ
 * @note Assumes that if x.hi is zero then x.lo is also zero.
 */
static inline __m256d _mm256_cmpnle_zero_pdx2(__m256dx2 x) {
	return _mm256_cmp_pd(x.hi, _mm256_setzero_pd(), _CMP_NLE_UQ);
}
/**
 * @brief _CMP_NGT_UQ
 * @note Assumes that if x.hi is zero then x.lo is also zero.
 */
static inline __m256d _mm256_cmpngt_zero_pdx2(__m256dx2 x) {
	return _mm256_cmp_pd(x.hi, _mm256_setzero_pd(), _CMP_NGT_UQ);
}
/**
 * @brief _CMP_NGE_UQ
 * @note Assumes that if x.hi is zero then x.lo is also zero.
 */
static inline __m256d _mm256_cmpnge_zero_pdx2(__m256dx2 x) {
	return _mm256_cmp_pd(x.hi, _mm256_setzero_pd(), _CMP_NGE_UQ);
}
...
static inline __m256dx2 _mm256x2_negate_pdx2(__m256dx2 x) {
	...
	x.hi = _mm256_xor_pd(x.hi, sign_bit_mask);
	x.lo = _mm256_xor_pd(x.lo, sign_bit_mask);
	return x;
}
...
/* values */
	...
	/**
	 * @brief Returns a __m256dx2 value set to positive infinity
	 */
 ...
 */
static inline __m256dx2 _mm256x2_fmax_pdx2(__m256dx2 x, __m256dx2 y) {
	__m256d fmax_cmp =
		_mm256_or_pd(
			_mm256_andnot_pd(
				_mm256_or_pd(
					_mm256_andnot_pd(
						_mm256_signbit_pdx2(x),
						_mm256_isnan_pdx2(y)
					),
					_mm256_isnan_pdx2(x)
				),
				_mm256_cmplt_pdx2(y, x)
			),
			_mm256_cmplt_pdx2(x, y)
		);
	__m256dx2 ret;
	ret.hi = _mm256_blendv_pd(x.hi, y.hi, fmax_cmp);
	ret.lo = _mm256_blendv_pd(x.lo, y.lo, fmax_cmp);
	return ret;
}
 ...
 */
static inline __m256dx2 _mm256x2_fmin_pdx2(__m256dx2 x, __m256dx2 y) {
	__m256d fmin_cmp =
		_mm256_or_pd(
			_mm256_andnot_pd(
				_mm256_or_pd(
				...
				_mm256_cmpgt_pdx2(y, x)
			),
			_mm256_cmpgt_pdx2(x, y)
		);
	__m256dx2 ret;
	ret.hi = _mm256_blendv_pd(x.hi, y.hi, fmin_cmp);
	ret.lo = _mm256_blendv_pd(x.lo, y.lo, fmin_cmp);
	return ret;
}
...
static inline __m256dx2 _mm256x2_max_pdx2(__m256dx2 x, __m256dx2 y) {
	...
	__m256dx2 ret;
	ret.hi = _mm256_blendv_pd(x.hi, y.hi, cmp_max);
	ret.lo = _mm256_blendv_pd(x.lo, y.lo, cmp_max);
	return ret;
}
...
static inline __m256dx2 _mm256x2_fdim_pdx2(__m256dx2 x, __m256dx2 y) {
	...
	__m256d cmp_nle = _mm256_cmpnle_zero_pdx2(ret);
	// NaN remains NaN, and -0.0 becomes +0.0
	ret.hi = _mm256_and_pd(ret.hi, cmp_nle);
	ret.lo = _mm256_and_pd(ret.lo, cmp_nle);
	return ret;
}
...
static inline __m256dx2 _mm256x2_sqrt_pdx2(__m256dx2 x) {
	...
	return _mm256x2_and_pdx2(
		_mm256x2_mul_power2_pdx2_pd(
			_mm256x2_add_pd_pdx2(guess, _mm256x2_div_pdx2_pd(x, guess)),
			_mm256_set1_pd(0.5)
		),
		// returns 0.0 on division by 0.0
		_mm256x2_cmp_extend_pd(
			_mm256_cmp_pd(guess, _mm256_setzero_pd(), _CMP_NEQ_UQ)
		)
	);
}
...
static inline __m256dx2 _mm256x2_cbrt_pdx2(__m256dx2 x) {
	...
	return _mm256x2_and_pdx2(
		_mm256x2_div_pdx2_pd(
			_mm256x2_add_pd_pdx2(
				_mm256_mul_pd(
					_mm256_set1_pd(2.0), guess
				),
				_mm256x2_div_pdx2(x, _mm256x2_square_pd(guess))
			),
			_mm256_set1_pd(3.0)
		),
		// returns 0.0 on division by 0.0
...
static inline __m256dx2 _mm256x2_ldexp_pdx2_epi32(__m256dx2 x, __m128i expon) {
	x.hi = _mm256_ldexp_pd_epi32(x.hi, expon);
	x.lo = _mm256_ldexp_pd_epi32(x.lo, expon);
	return x;
}
...
static inline __m256dx2 _mm256x2_frexp_pdx2_epi64(__m256dx2 x, __m256i* const expon) {
	...
	x.lo = _mm256_ldexp_pd_epi32(x.lo, _mm_sub_epi32(_mm_set1_epi32((int32_t)1), expon_32));
	return x;
}
#endif
...
/** @note This function doesn't use AVX for calculations */
static inline __m256dx2 _mm256x2_exp2_pdx2(const __m256dx2 x) {
	return _mm256x2_exp_pdx2(_mm256x2_mul_pdx2(x, _mm256x2_const_ln2_pdx2()));
}

/** @note This function doesn't use AVX for calculations */
static inline __m256dx2 _mm256x2_exp10_pdx2(const __m256dx2 x) {
	return _mm256x2_exp_pdx2(_mm256x2_mul_pdx2(x, _mm256x2_const_ln10_pdx2()));
}
...
static inline __m256dx2 _mm256x2_log2_pdx2(const __m256dx2 x) {
	return _mm256x2_mul_pdx2(_mm256x2_log_pdx2(x), _mm256x2_const_log2e_pdx2());
}

/** @note This function doesn't use AVX for calculations */
static inline __m256dx2 _mm256x2_log10_pdx2(const __m256dx2 x) {
	return _mm256x2_mul_pdx2(_mm256x2_log_pdx2(x), _mm256x2_const_log10e_pdx2());
}
...
#if 0
	// Avoiding multiple __m256dx2 to Float64x2 conversions
