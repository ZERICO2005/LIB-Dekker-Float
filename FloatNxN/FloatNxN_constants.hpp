...
/* Multiples of pi */
template<typename T> inline constexpr T const_pi            ; /**< ~3.141592654 `pi` */
template<typename T> inline constexpr T const_2pi           ; /**< ~6.283185307 `2 * pi` */
template<typename T> inline constexpr T const_pi2           ; /**< ~1.570796327 `pi / 2` */
template<typename T> inline constexpr T const_pi4           ; /**< ~0.785398163 `pi / 4` */
template<typename T> inline constexpr T const_3pi4          ; /**< ~2.356194490 `3/4 * pi` */
template<typename T> inline constexpr T const_pi3           ; /**< ~1.047197551 `pi / 3` */

/* Inverse and sqrt pi */
template<typename T> inline constexpr T const_inv_pi        ; /**< ~0.318309886 `1 / pi` */
template<typename T> inline constexpr T const_inv_2pi       ; /**< ~0.159154943 `1 / (2 * pi)` */
template<typename T> inline constexpr T const_sqrtpi        ; /**< ~1.772453851 `sqrt(pi)` */
template<typename T> inline constexpr T const_sqrt2pi       ; /**< ~2.506628275 `sqrt(2 * pi)` */
template<typename T> inline constexpr T const_inv_sqrtpi    ; /**< ~0.564189584 `1 / sqrt(pi)` */
template<typename T> inline constexpr T const_inv_sqrt2pi   ; /**< ~0.398942280 `1 / sqrt(2 * pi)` */
...
template<typename T> inline constexpr T const_inv_sqrt2     ; /**< ~0.707106781 `1 / sqrt(2)` */
...
template<typename T> inline constexpr T const_lemniscate2   ; /**< ~1.311028777 `lemniscate / 2` */
template<typename T> inline constexpr T const_gauss         ; /**< ~0.834626842 `lemniscate / pi` */
...
template<> inline constexpr long double LDF::const_cbrt2         <long double> = 1.2599210498948731647672106072782283505703L;
template<> inline constexpr long double LDF::const_cbrt3         <long double> = 1.4422495703074083823216383107801095883919L;
template<> inline constexpr long double LDF::const_cbrt5         <long double> = 1.7099759466766969893531088725438601098681L;
template<> inline constexpr long double LDF::const_cbrt6         <long double> = 1.8171205928321396588912117563272605024282L;
...
template<> inline constexpr long double LDF::const_inv_tribonacci<long double> = 0.5436890126920763615708559718017479865252L;
...
template<> inline constexpr long double LDF::const_gompertz      <long double> = 0.5963473623231940743410784993692793760742L;
...
template<> inline constexpr double LDF::const_cbrt2         <double> = 1.259921049894873164767;
template<> inline constexpr double LDF::const_cbrt3         <double> = 1.442249570307408382322;
template<> inline constexpr double LDF::const_cbrt5         <double> = 1.709975946676696989353;
template<> inline constexpr double LDF::const_cbrt6         <double> = 1.817120592832139658891;
...
template<> inline constexpr double LDF::const_inv_tribonacci<double> = 0.543689012692076361571;
...
template<> inline constexpr double LDF::const_gompertz      <double> = 0.596347362323194074341;
...
template<> inline constexpr float LDF::const_cbrt2         <float> = 1.25992104989f;
template<> inline constexpr float LDF::const_cbrt3         <float> = 1.44224957031f;
template<> inline constexpr float LDF::const_cbrt5         <float> = 1.70997594668f;
template<> inline constexpr float LDF::const_cbrt6         <float> = 1.81712059283f;
...
template<> inline constexpr float LDF::const_inv_tribonacci<float> = 0.54368901269f;
...
template<> inline constexpr float LDF::const_gompertz      <float> = 0.59634736232f;
